...
const _base_texture_folder = "res://Singleplayer/addons/devblocks/textures/"
...
func _ready():
	_mesh.set_surface_override_material(0, load("res://Singleplayer/addons/devblocks/blocks/block_material.tres").duplicate(true))
	_update_mesh()
	_update_uvs()
